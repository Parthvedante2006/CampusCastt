...
class _PostEventScreenState extends ConsumerState<PostEventScreen> {
  ...
  Future<void> _createEvent() async {
    ...
    try {
      ...
      // Create event in Firebase Firestore
      final firestoreService = ref.read(sectionFirestoreServiceProvider);
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: _buildDateTimeField(
                    'Time',
                    _eventTime != null ? _eventTime!.format(context) : '--:-- --',
